		...
		public static void personalbackground() {
			...
			public static void employeeSalary() {
				...
				public static void printserviceprovide() {
					...
					int[] services3 = {10, 12, 15};
					
					for(int i = 0; i < services1.length; i++) {
						System.out.println("Service No." + services1[i] + ": " + services2[i] + " - RM" + services3[i] + " per hour");
					}
				...
				public static void printquantityservice() {
					...
					do {
						...
						if (servicenum == services1[0]) {
							System.out.println("- Order Details -");
							System.out.println("Service Ordered : " + services2[0]);
						    System.out.println("Hours Ordered   : " + servicehour + " hours");
						    System.out.println("Total Charge    : RM" + servicehour*services3[0]);
						    
						} 
						
						else if (servicenum == services1[1]) {
							System.out.println("- Order Details -");
							System.out.println("Service Ordered : " + services2[1]);
							System.out.println("Hours Ordered   : " + servicehour + " hours");
							System.out.println("Total Charge    : RM" + servicehour*services3[1]);
						} 
						
						else if (servicenum == services1[2]) {
							System.out.println("- Order Details -");
							System.out.println("Service Ordered : " + services2[2]);
							System.out.println("Hours Ordered   : "+ servicehour + " hours");
							System.out.println("Total Charge    : RM" + servicehour*services3[2]);
						} 
						
						else {
							System.out.println("Oops! The number you entered is not in the services.");
							System.out.println("Please re-enter your order.");
							System.out.println();
							printquantityservice(); 
						} 
				...
				public static void printconfirmservice() {
					...
					if(confirmPayment == 'Y' || confirmPayment == 'y') {
						...
						System.out.println("Please exit and re-enter the information and order.");
					}
	}
				...
				public static void services() {
					...
					System.out.println("1. "+service[0]);
					System.out.println("2. "+service[1]);
					System.out.println("3. "+service[2]);
					System.out.println("4. "+service[3]);
					System.out.println("5. "+service[4]);
					System.out.println();
